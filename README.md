...
* **rquickshare (Rust):** [Abstracted core network I/O through generic transport traits](https://github.com/Martichou/rquickshare/pull/420)

### Selected projects
* **[Sirius](https://github.com/alexandr-tk/sirius):** Open source Blender tool for designing drone shows. The current alpha supports parametric launch grids and per drone LED animation.
* **[Inline](https://inlinetutor.com):** A writing tutor that asks questions, not answers. The project is in open beta and won first place at Lafayette's annual pitch competition.
